...
WRITE_REGISTER_SESSION_ENERGY_LIMIT = 5010
WRITE_REGISTER_UNLOCK_PLUG = 5012
WRITE_REGISTER_CHARGER_ENABLE = 5014
WRITE_REGISTER_FAILSAFE_CURRENT = 5016
WRITE_REGISTER_FAILSAFE_TIMEOUT = 5018
WRITE_REGISTER_FAILSAFE_PERSIST = 5020
WRITE_REGISTER_PHASE_SWITCH_SOURCE = 5050
WRITE_REGISTER_PHASE_SWITCH_STATE = 5052
WRITE_REGISTER_FAST_CHARGING = 5200
...
SLOW_RUNTIME_REGISTER_KEYS: frozenset[str] = frozenset(
    {
        KEY_TOTAL_ENERGY,
